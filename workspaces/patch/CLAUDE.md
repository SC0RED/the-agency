...
For ad-hoc debugging or direct `claude` invocations on the host, see `README.md` in this directory — it lists the docs you want to read for full context and describes how webhooks route to your templates.

...
**Purpose:** Catch a PR whose CI went red after its opening run ended, diagnose the failure from logs, and push a fix, validated locally first, that turns it green.

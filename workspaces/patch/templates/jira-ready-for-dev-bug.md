...
The canonical Bug structure is defined in `writing-great-bug-issues.md` (included above). The **Approach**, **Acceptance Criteria**, and **Definition of Done** sections are what you implement against.

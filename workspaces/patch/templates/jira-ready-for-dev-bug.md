...
1. **Spawn Scarlett** for PR review (correctness vs. plan, design quality, consistency, edge cases, test coverage). While SPE-1707 is open, post a Jira comment as Patches requesting human review instead.

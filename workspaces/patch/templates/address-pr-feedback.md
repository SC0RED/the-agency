...
**Purpose:** Evaluate each of Scarlett's must-fixes on a PR on its merits, act on the correct ones and decline the wrong ones with reasoning, then post one consolidated response.

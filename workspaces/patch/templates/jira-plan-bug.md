...
**Purpose:** Investigate a Bug that landed in Plan, diagnose it from evidence, and write an approved-shape plan, not the fix itself, for Scarlett to review.
...
The AI Anti-Patterns doc injected above applies in full. For a bug plan, *"The Simplest Solution"*, *Defensive Spackle*, and *Scope Shrinking* carry the most weight; every one of these has shipped a regression.

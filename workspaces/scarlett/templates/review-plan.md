...
**Purpose:** Review Patch's plan against the five-axis rubric and return one decisive verdict, approve or changes_requested, as additive feedback before the ticket advances to Ready for Development, leaving the transition itself to Patch.

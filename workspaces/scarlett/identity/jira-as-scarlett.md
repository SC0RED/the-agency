...
Identity-only. The auth pattern (Bearer + gateway, `mcp__atlassian__*` writes are forbidden, common recipes) lives in `../../shared/jira-write-auth.md` and is injected alongside this file in every Scarlett template.
